...
const Operacao = () => {
  ...
  function LigBomb(event) { // altera os poster
  ...
  function deslBomb(event) { // altera os poster
    event.preventDefault();
  ...
  function ligSole(event) { // altera os poster
    event.preventDefault();
  ...
  function deslSole(event) { // altera os poster
    event.preventDefault();
  ...
  function man(event) { // altera os poster
    event.preventDefault();
  ...
  function aut(event) { // altera os poster
    event.preventDefault();
