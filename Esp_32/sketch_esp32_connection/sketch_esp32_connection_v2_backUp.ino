...
int analogValue;
const char* ssid = "ezequias";
const char* password = "senai2023";
char jsonOutput[128];
...
void GET() {
  if (WiFi.status() == WL_CONNECTED) {
    ...
    client.begin("https://supervisorio-production.up.railway.app/operation_water_pump");
...
//Requisição POST
 void POST() {
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    client.begin("https://supervisorio-production.up.railway.app/water_level");
